...
void file_ok_sel( GtkWidget        *w, ihm_trick_t *ihm_pli );
void open_file (GtkButton *button,ihm_trick_t *ihm_pli); 
void save_game (GtkButton *button,ihm_trick_t *ihm_pli);
void enter_callback_level( GtkWidget *entry,ihm_trick_t *ihm_pli);
void enter_callback_random( GtkWidget *entry,ihm_trick_t *ihm_pli);
