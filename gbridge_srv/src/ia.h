...
int definition_prof ( trick_t *pli_cur);
rettrick_t * explore (int prof, trick_t * pli_cur, int prof_max,int *nb_best,l_best_t *l_best);
int  first_explore ( trick_t *pli, int prof_max,int *nb_best,l_best_t *l_best,game_t *game);
rettrick_t * cur_explore (int prof , trick_t *pli_cur, int prof_max,tablist_t **t_jeu,int orialpha,int oribeta,int nbcard);
